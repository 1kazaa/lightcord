...
import {
    ...
    RestartIcon,
    Span
} from "@LIGHTCORD/types/components";
import {
    closeModal,
    Logger,
    ModalCloseButton,
...
import { onceReady } from "@LIGHTCORD/types/webpack";
import { FluxDispatcher, MediaEngineStore, Select, UserStore, useState } from "@LIGHTCORD/types/webpack/common";
...
const logger = new Logger("LIGHTCORDScreenShare");
