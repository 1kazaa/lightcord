...
import { Button, Flex, Heading, Paragraph } from "@LIGHTCORD/types/components";
import { ModalContent, ModalFooter, ModalHeader, ModalRoot, ModalSize } from "@LIGHTCORD/types/utils";
import { React } from "@LIGHTCORD/types/webpack/common";
            ...
            <ModalContent style={{ padding: "16px 24px" }}>
                <div style={{
                    ...
                    <Paragraph style={{ fontWeight: "bold", marginBottom: "6px", color: "var(--text-normal)" }}>
                        LIGHTCORDFr is a 100% Free product.
                    </Paragraph>
                    ...
                    <ul style={{ listStyle: "none", padding: 0, margin: 0 }}>
                        ...
                        <li style={{ color: "var(--text-normal)" }}>
                            ...
                            <span
                                ...
                                onClick={() => window.open("https://discord.gg/LIGHTCORD", "_blank")}
                            >
                                discord.gg/LIGHTCORD
                            </span>
                        </li>
                    </ul>
                </div>
                ...
                <div style={{
                    ...
                    <Paragraph style={{ color: "var(--text-muted)", fontStyle: "italic", fontSize: "13px" }}>
                        <strong>Note:</strong> Only download LIGHTCORDFr via our official channels to ensure your security.
                    </Paragraph>
                </div>
            </ModalContent>
