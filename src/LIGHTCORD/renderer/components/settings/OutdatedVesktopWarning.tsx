...
import { Button, Card, HeadingTertiary, Paragraph } from "@LIGHTCORD/types/components";
import { useAwaiter } from "@LIGHTCORD/types/utils";
...
export function OutdatedVesktopWarning() {
    ...
    return (
        <Card variant="warning" className={cl("updater-card")}>
            <HeadingTertiary>Your LIGHTCORD is outdated!</HeadingTertiary>
