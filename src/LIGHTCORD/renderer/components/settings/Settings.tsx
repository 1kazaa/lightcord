...
import { classNameFactory } from "@LIGHTCORD/types/api/Styles";
import { BaseText, Divider, ErrorBoundary } from "@LIGHTCORD/types/components";
...
const SettingsOptions: Record<string, Array<BooleanSetting | SettingsComponent>> = {
    ...
    "User Interface": [
        ...
        },
        {
            key: "staticTitle",
            title: "Static Title",
            description: 'Makes the window title "LIGHTCORD" instead of changing to the current page',
            defaultValue: false
        },
        {
            key: "enableMenu",
        ...
        },
        {
            ...
            description:
                "Shows a small splash screen while LIGHTCORD is loading. Disabling this option will show the main window earlier while it's still loading.",
            defaultValue: true
        },
        {
            key: "splashTheming",
    ...
    Behaviour: [
        {
            key: "tray",
            title: "Tray Icon",
            description: "Add a tray icon for LIGHTCORD",
            defaultValue: true,
            invisible: () => isMac
        },
        {
            ...
            description: "Hitting X will make LIGHTCORD minimize to the tray instead of closing",
            defaultValue: true,
            invisible: () => isMac,
        ...
        },
        {
            ...
            description: "Left clicking tray icon will toggle the LIGHTCORD window visibility.",
            defaultValue: false
        },
        {
            key: "disableMinSize",
    ...
    Miscellaneous: [
        ...
        },
        {
            ...
            description: "Opens links in a new LIGHTCORD window instead of your web browser",
            defaultValue: false
        }
    ],
...
export default ErrorBoundary.wrap(
    ...
    {
        message:
            "Failed to render the LIGHTCORD Settings tab. If this issue persists, try to right click the LIGHTCORD tray icon, then click 'Repair LIGHTCORD'. And make sure your LIGHTCORD is up to date."
    }
);
