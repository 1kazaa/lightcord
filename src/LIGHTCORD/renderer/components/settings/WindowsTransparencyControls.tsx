...
import { Heading, Paragraph } from "@LIGHTCORD/types/components";
import { Margins } from "@LIGHTCORD/types/utils";
import { Select } from "@LIGHTCORD/types/webpack/common";
            ...
            <SimpleErrorBoundary>
                <Select
                    ...
                    options={[
                        ...
                        {
                            label: "Acrylic (blurs the window behind LIGHTCORD for a translucent background)",
                            value: "acrylic"
                        }
                    ]}
                    closeOnSelect={true}
