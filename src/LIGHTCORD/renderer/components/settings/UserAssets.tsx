...
import { BaseText, Button, FormSwitch } from "@LIGHTCORD/types/components";
import {
    Margins,
    ModalCloseButton,
    ModalContent,
...
import { showToast, useState } from "@LIGHTCORD/types/webpack/common";
        ...
        <section>
            ...
            <div className="vcd-user-assets-asset">
                <img
                    ...
                    src={`LIGHTCORD://assets/${asset}?v=${version}`}
                    alt=""
