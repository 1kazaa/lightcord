...
import { useState } from "@LIGHTCORD/types/webpack/common";
    ...
    return (
        <>
            <VesktopSettingsSwitch
                ...
                description="Automatically start LIGHTCORD on computer start-up"
            ...
            <VesktopSettingsSwitch
                ...
                description={"Start LIGHTCORD minimized when starting with system"}
