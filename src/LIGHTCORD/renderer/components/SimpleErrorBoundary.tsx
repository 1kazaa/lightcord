...
import { Card, ErrorBoundary, HeadingTertiary, Paragraph, TextButton } from "@LIGHTCORD/types/components";
import { FluxDispatcher, InviteActions } from "@LIGHTCORD/types/webpack/common";
...
function Fallback() {
    return (
        <Card variant="danger">
            ...
            <Paragraph>
                Please make sure LIGHTCORD and LIGHTCORD are fully up to date. You can get help in our{" "}
