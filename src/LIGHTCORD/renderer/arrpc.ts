...
import { Logger } from "@LIGHTCORD/types/utils";
import { findLazy, onceReady } from "@LIGHTCORD/types/webpack";
import {
    ...
    InviteActions,
    StreamerModeStore
} from "@LIGHTCORD/types/webpack/common";
import { IpcCommands } from "shared/IpcEvents";

import { onIpcCommand } from "./ipcCommands";

const logger = new Logger("LIGHTCORDRPC", "#5865f2");
