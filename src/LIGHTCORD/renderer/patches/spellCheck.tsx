...
import { addContextMenuPatch } from "@LIGHTCORD/types/api/ContextMenu";
import { FluxDispatcher, Menu, SpellCheckStore, useMemo, useStateFromStores } from "@LIGHTCORD/types/webpack/common";
