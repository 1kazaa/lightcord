...
export async function downloadVencordAsar() {
    await downloadFile(
        "https://github.com/LIGHTCORD/LIGHTCORD/releases/latest/download/LIGHTCORD.asar",
        VENCORD_DIR,
        {},
...
export function isValidVencordInstall(dir: string) {
    return existsSync(join(dir, "LIGHTCORD/main.js"));
}

export async function ensureVencordFiles() {
    if (!existsSync(VENCORD_DIR)) {
        console.error("Bundled LIGHTCORD.asar not found at", VENCORD_DIR);
    }
}
