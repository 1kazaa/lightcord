...
const LIGHTCORDDir = dirname(process.execPath);

export const PORTABLE =
    process.platform === "win32" &&
    !process.execPath.toLowerCase().endsWith("electron.exe") &&
    !existsSync(join(LIGHTCORDDir, "Uninstall LIGHTCORD.exe"));

export const DATA_DIR =
    process.env.LIGHTCORD_USER_DATA_DIR || (PORTABLE ? join(LIGHTCORDDir, "Data") : join(app.getPath("userData")));
...
export const USER_AGENT = `LIGHTCORD/${app.getVersion()} (https://github.com/LIGHTCORD/LIGHTCORD)`;
