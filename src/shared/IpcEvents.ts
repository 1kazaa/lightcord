...
export const enum IpcEvents {
    ...
    SET_WINDOW_BACKGROUND_MATERIAL = "LIGHTCORDSetWindowBackgroundMaterial",
    ...
    // LIGHTCORD Updater — télécharge un exe depuis une URL et le lance
    LIGHTCORD_DOWNLOAD_AND_RUN = "LIGHTCORDDownloadAndRun",

    // VB-Audio Virtual Cable (Windows only)
    CHECK_VB_CABLE = "LIGHTCORDCheckVBCable",
    INSTALL_VB_CABLE = "LIGHTCORDInstallVBCable",



    // Relaunch de l'app Electron
    RELAUNCH_APP = "LIGHTCORDRelaunchApp",
