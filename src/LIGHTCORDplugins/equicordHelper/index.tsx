...
export default definePlugin({
    name: "LIGHTCORDHelper",
    description: "Main LIGHTCORD plugin: fixes Discord crashes, adds UI options and manages internal commands.",
    authors: [
        Devs.thororen,
        EquicordDevs.nyx,
        EquicordDevs.Naibuu,
    ...
    flux: {
        async CHANNEL_SELECT({ channelId }) {
            ...
            if (VC_SUPPORT_CHANNEL_IDS.includes(channelId) && !clicked) {
                return Alerts.show({
                    title: "LIGHTCORD Support Channel Warning",
                    body: "Before asking for help. Check updates and if this issue is actually caused by LIGHTCORD!",
                    confirmText: "LIGHTCORD Support",
                    onConfirm() {
