...
const LS_KEY_DATA = "LIGHTCORDCP_data";
const LS_KEY_ENABLED = "LIGHTCORDCP_enabled";
const DS_ALL_DATA = "customProfile_allData";
const DS_ALL_ENABLED = "customProfile_allEnabled";
const LS_ALL_DATA = "LIGHTCORDCP_allData";
const LS_ALL_ENABLED = "LIGHTCORDCP_allEnabled";
