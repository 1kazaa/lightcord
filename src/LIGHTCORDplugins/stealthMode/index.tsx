/*
 * LIGHTCORD - StealthMode plugin
 * Cache tous les boutons de plugins (barre du haut, zone texte, zone utilisateur)
 * Toggle : Ctrl+Shift+H ou bouton dans LIGHTCORD Settings.
 *
...
export default definePlugin({
    ...
    description: "Hides all plugin buttons without disabling them. Shortcut: Ctrl+Shift+H. The toggle is in LIGHTCORD Settings.",
    ...
    stop() {
        document.body.classList.remove("LIGHTCORD-stealth");
    },
});
