...
import { groqChat, getGroqKey } from "../LIGHTCORDAI/groqManager";
            ...
            <div style={{
                ...
                <div>
                    ...
                    <div style={{ fontSize: "13px", marginTop: "4px" }}>
                        ...
                        Please configure it once in the <strong>LIGHTCORDAI</strong> settings.
                    </div>
                </div>
            </div>
        )
        ...
        if (!apiKey) {
            try {
                ...
                openConfirmationModal({
                    ...
                    content: "AutoResponder requires a Groq API Key to function. Please configure it once in the LIGHTCORDAI settings.",
                    confirmText: "Configure LIGHTCORDAI",
                    cancelText: "Cancel",
                    onConfirm: () => {
                        const { openModal } = findByPropsLazy("openModal");
                        // Logique pour ouvrir les settings LIGHTCORDAI si possible
                    }
                });
            } catch (e) {
