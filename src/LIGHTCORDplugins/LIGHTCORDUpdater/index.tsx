...
const REMOTE_VERSION_URL =
    "https://api.github.com/repos/LIGHTCORDoff/LIGHTCORD/releases/latest";
...
async function checkForUpdates() {
    try {
        ...
        console.log(`[LIGHTCORDUpdater] local=${localVersion} remote=${remoteVersion}`);
        ...
        console.error("[LIGHTCORDUpdater] Error vérification:", e);
    }
}
...
function UpdateBanner() {
    ...
    async function doUpdate() {
        ...
        try {
            ...
            setTimeout(() => {
                try {
                    VencordNative.LIGHTCORD?.relaunch?.();
                } catch {
            ...
            console.error("[LIGHTCORDUpdater] Error mise à jour:", e);
    ...
    return React.createElement("div", {
        ...
        React.createElement("div", {
            ...
            React.createElement("span", { style: { fontWeight: 700, flexShrink: 0 } },
                `🔔 LIGHTCORD ${info.remoteVersion} available!`
            ),
...
function mountBanner() {
    if (bannerContainer || document.getElementById("LIGHTCORD-updater-root")) return;
    bannerContainer = document.createElement("div");
    bannerContainer.id = "LIGHTCORD-updater-root";
    ...
    try {
        ...
        console.error("[LIGHTCORDUpdater] Error montage bannière:", e);
    }
}
