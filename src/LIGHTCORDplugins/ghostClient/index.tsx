...
const DS_KEY_TOKENS = "LIGHTCORD-ghost-tokens";
const DS_KEY_AUTO_FOLLOW = "LIGHTCORD-ghost-autofollow";
const DS_KEY_MIC_DEVICE = "LIGHTCORD-ghost-mic-device-label";
const DS_KEY_SELECTED = "LIGHTCORD-ghost-selected";
