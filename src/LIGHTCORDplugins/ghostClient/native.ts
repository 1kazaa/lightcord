 ...
 * Lance ghost-server via node.exe bundlé dans LIGHTCORD-dist
...
// Handler IPC pour ouvrir les URLs externes (utilisé par LIGHTCORDUpdater)
ipcMain.handle("LIGHTCORD_OPEN_URL", (_event, url: string) => {
