...
import { getGroqKey } from "../LIGHTCORDAI/groqManager";
...
async function transcribe(blob: Blob): Promise<string> {
    ...
    if (!apiKey) {
        throw new Error("API key missing — Configure your key in Settings → LIGHTCORDAI");
    }
...
export default definePlugin({
    ...
    description: "Real-time voice dictation via Groq Whisper (free). API key shared with LIGHTCORDAI.",
