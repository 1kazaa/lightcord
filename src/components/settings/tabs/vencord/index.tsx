...
import { ContributeModal } from "../../../../LIGHTCORD/renderer/components/ContributeModal";
...
const DEV_TEAM = [
    {
        ...
        description: "Founder and owner of LIGHTCORD."
    },
    {
        id: "kza",
        name: "Kza",
        ...
        description: "Co-owner of LIGHTCORD."
    },
    {
        id: "attachante",
        name: "attachante",
        ...
        description: "Developer within the LIGHTCORD team."
    },
    {
        id: "Fancy",
        name: "Fancy",
    ...
    },
    {
        ...
        description: "Bot developer for LIGHTCORD."
    },
    {
        id: "biemal",
        name: "Biemal",
        ...
        description: "WebApp developer within the LIGHTCORD team."
    }
];
    ...
    return (
        <>
            <QuickActionCard>
                ...
                <QuickAction
                    Icon={PlanetIcon}
                    text="LIGHTCORD Server"
                    action={() => window.open("https://discord.gg/LIGHTCORD", "_blank")}
                />
            </QuickActionCard>
...
function useStealthActive() {
    ...
    React.useEffect(() => {
        ...
        window.addEventListener("LIGHTCORD-stealth-change", handler);
        return () => window.removeEventListener("LIGHTCORD-stealth-change", handler);
    }, []);
    return active;
}
    ...
    return (
        <>
            ...
            <Paragraph className={Margins.bottom16}>
                {enabled
                    ? "Stealth mode is enabled — all LIGHTCORD visual elements are hidden. Shortcut: Ctrl+Shift+H"
                    : "Hides all LIGHTCORD visual elements (icons, buttons, context menus) without disabling plugins. Shortcut: Ctrl+Shift+H"}
            </Paragraph>
            <Button
    ...
    return (
        <SettingsTab>
            ...
            {!stealthActive && (<>
                ...
                <Paragraph className={Margins.bottom16}>
                    Configure how LIGHTCORD behaves and integrates with Discord. These settings affect the Discord client's appearance and behavior.
                </Paragraph>
                ...
                <Paragraph className={Margins.bottom16}>
                    Configure how LIGHTCORD handles notifications. You can customize when and how you receive alerts, or view a history of past notifications.
                </Paragraph>
            ...
            <Heading className={Margins.top20}>Stealth Mode</Heading>
            <Paragraph className={Margins.bottom16}>
                Hides all LIGHTCORD visual elements without disabling plugins. Shortcut: Ctrl+Shift+H
            </Paragraph>
            <StealthModeButton />
...
export default wrapTab(EquicordSettings, "LIGHTCORD Settings");
