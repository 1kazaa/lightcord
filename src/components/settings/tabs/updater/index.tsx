/*
 * LIGHTCORD — Onglet Updater dans les Settings
...
const REPO_URL = "https://github.com/LIGHTCORDoff/LIGHTCORD";
...
function UpdaterTab() {
    ...
    return (
        <SettingsTab>
            <Heading className={Margins.top16}>LIGHTCORD Updater</Heading>
            <Paragraph className={Margins.bottom20}>
                Check for new versions of LIGHTCORD. Updates can be installed automatically.
            </Paragraph>
            ...
            <Card style={{ padding: "12px 16px", marginBottom: 12 }}>
                <Flex style={{ alignItems: "center", justifyContent: "space-between" }}>
                    ...
                    <div>
                        ...
                        <div>
                            <Link href="https://LIGHTCORD.online" style={{ fontSize: 13 }}>
                                LIGHTCORD.online
                            </Link>
                        </div>
                    </div>
