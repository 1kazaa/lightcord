    ...
    return (
        <SettingsTab>
            ...
            <Notice.Info className={Margins.bottom16} style={{ width: "100%" }}>
                Looking for themes? Check out <Link href="https://LIGHTCORD.online/themes">LIGHTCORD Themes</Link> or search on <Link href="https://github.com/search?q=discord+theme">GitHub</Link>. When downloading from BetterDiscord, click "Download" and place the .theme.css file into your themes folder.
            </Notice.Info>
