/*
 * LIGHTCORD — Utilitaire pop-up clé API manquante
 */
        ...
        <ModalRoot transitionState={1 as any} size="small">
            <ModalContent style={{ padding: "24px 20px 8px" }}>
                <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 12, textAlign: "center" }}>
                    ...
                    <div style={{ fontSize: 14, color: "#fff", lineHeight: 1.5 }}>
                        ...
                        <br /><br />
                        Configure-la une seule fois dans les paramètres de <strong style={{ color: "#fff" }}>LIGHTCORDAI</strong>.
                    </div>
                </div>
            </ModalContent>
            <ModalFooter style={{ display: "flex", justifyContent: "center", gap: 8, padding: "12px 20px 20px" }}>
                <button
                    ...
                    onClick={() => {
                        onClose();
                        const plugin = Plugins["LIGHTCORDAI"];
                        if (plugin) openPluginModal(plugin);
                    }}
                >
                    Configurer LIGHTCORDAI
                </button>
                <button
                    style={{
