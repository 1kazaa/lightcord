...
function patchLatest() {
    try {
        ...
        console.info("[LIGHTCORD] Detected Host Update. Repatching...");
        ...
        writeFileSync(join(app, "index.js"), `// LIGHTCORD repatch\n"use strict";\nconst path = require("path");\nrequire(path.join(__dirname, "..", "app", "dist", "desktop", "patcher.js"));`);
    } catch (err) {
        console.error("[LIGHTCORD] Failed to repatch latest host update", err);
    }
}
