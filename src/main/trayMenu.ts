...
function createLIGHTCORDMenuItems(): MenuItemConstructorOptions[] {
    return [
        {
            label: "LIGHTCORD",
            submenu: [
                ...
                {
                    label: cachedUpdateAvailable ? "Update LIGHTCORD" : "Check for Updates",
...
export function patchTrayMenu(): void {
    // On ne patch plus le menu tray — LIGHTCORD gère son propre tray dans patcher.ts
}
