...
let LIGHTCORDBadges = {} as Record<string, Array<Record<"tooltip" | "badge", string>>>;
...
export default definePlugin({
    ...
    getLIGHTCORDBadges(userId: string) {
        try {
            const userBadges = LIGHTCORDBadges[userId];
            ...
            for (const badge of userBadges) {
                ...
                results.push({
                    iconSrc: iconSrc,
                    description: (badge as any).tooltip || (badge as any).description || (badge as any).label || "LIGHTCORD Badge",
