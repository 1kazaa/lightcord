/*
 * LIGHTCORD — Injection CSS globale pour masquer les boutons natifs Discord
 */

import { Devs } from "@utils/constants";
import definePlugin from "@utils/types";

const STYLE_ID = "LIGHTCORD-hide-native-buttons";

const CSS = `
/* ── LIGHTCORD : suppression boutons natifs Discord non désirés ── */
