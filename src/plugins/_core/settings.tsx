...
import IconsTab from "@LIGHTCORDplugins/iconViewer/components/IconsTab";
...
import { CreateThemeTab } from "@LIGHTCORDplugins/createTheme/components/CreateThemeTab";
import { PencilSparkleIcon } from "@LIGHTCORDplugins/createTheme/components/PencilSparkleIcon";
...
const settings = definePluginSettings({
    settingsLocation: {
        ...
        description: "Where to put the LIGHTCORD settings section",
        options: [
...
export default definePlugin({
    ...
    buildLayout(originalLayoutBuilder: SettingsLayoutBuilder) {
        ...
        const equicordSection: SettingsLayoutNode = {
            ...
            useTitle: () => {
                try { if (localStorage.getItem("LIGHTCORD_stealthMode") === "1") return ""; } catch { }
                return "LIGHTCORD Settings";
            },
            buildLayout: () => {
                try { if (localStorage.getItem("LIGHTCORD_stealthMode") === "1") return [mainEntry]; } catch { }
                return fullEntries;
            }
        };
    ...
    getInfoRows() {
        ...
        const rows = [`LIGHTCORD ${gitHashShort}${getVersionInfo()}`];
