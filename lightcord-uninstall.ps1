# ==============================================================================
#  LIGHTCORD — Désinstalleur utilisateur (PowerShell)
#  Supprime l'injection LIGHTCORD de Discord
#
...
$InstallDir    = Join-Path $env:LOCALAPPDATA "LIGHTCORD-Client"
...
Write-Host "  ║      LIGHTCORD — Désinstalleur           ║" -ForegroundColor Cyan
Write-Host "  ╚══════════════════════════════════════════╝" -ForegroundColor Cyan
Write-Host ""
...
Write-Host "  │  LIGHTCORD désinstallé avec succès !                 │" -ForegroundColor Green
