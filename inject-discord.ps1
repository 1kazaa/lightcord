# ==============================================================================
#  LIGHTCORD — Script d'injection Post-Installation
#  Utilisé par l'installateur Inno Setup pour injecter LIGHTCORD dans Discord.
# ==============================================================================
...
# On pointe vers le patcher.js dans le dossier d'installation de LIGHTCORD
$LIGHTCORDPatcher = Join-Path $AppDir "dist\desktop\patcher.js"
$LIGHTCORDPatcher = $LIGHTCORDPatcher.Replace("\", "\\")
...
// Injection LIGHTCORD
try {
    require(\"$LIGHTCORDPatcher\");
} catch (e) {
    console.error(\"LIGHTCORD injection failed:\", e);
